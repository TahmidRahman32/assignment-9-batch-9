...
const Card = ({ card }) => {
   ...
   return (
      <div className="max-w-lg p-4 shadow-xl rounded-xl focus:no-underline transition border-2 hover:scale-105  hover:border-red-300 border-opacity-30 animate__animated animate__bounce animate__slower  animate__backInRight">
