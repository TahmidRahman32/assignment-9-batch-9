      ...
      <footer className="px-4 divide-y bg-gray-800 text-gray-100 ">
         <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
            <div className="lg:w-1/3">
               <div className="flex justify-center items-center space-x-3 lg:justify-start">
                  <div className="flex items-center justify-center w-20 h-20 rounded-full py-3 px-2 bg-gray-200">
                     <img src="https://newhome.qodeinteractive.com/wp-content/uploads/2023/03/client-7.png" alt="" />
                  </div>
                  <div className="">
                     <span className="self-center text-2xl font-semibold">ALTAIR GROUP</span> <br />
                     <span className="self-center text-sm  font-semibold">Tahmid Rahman</span>
                  </div>
               </div>
            </div>
